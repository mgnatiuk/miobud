import { Hammer, MapPin, Phone, Mail, Heart } from "lucide-react";
                        ...
                        <div>
                            ...
                            <div className="flex space-x-3">
                                <a
                                    ...
                                    className="bg-gray-800 hover:bg-amber-600 p-2.5 rounded-lg transition-all duration-300 hover:scale-110"
                                    aria-label="Facebook"
                                >
                        ...
                        <ul className="space-y-3">
                            {quickLinks.map((link) => (
                                <li key={link.key}>
                                    <a
                                        href={link.href}
                                        className="text-sm hover:text-amber-500 transition-colors duration-300 flex items-center group"
                                    >
